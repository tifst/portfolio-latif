export default function Hero() {
  return (
    <section className="relative flex items-center bg-black text-white">
      
      {/* Background gradient */}
      <div className="absolute inset-0 bg-linear-to-br from-green-800/40 via-black to-black"></div>
          ...
          <div className="group w-80 h-80 md:w-80 md:h-100 rounded-full overflow-hidden border-3 border-white bg-black">
            <img
              ...
              className="
                ...
                md:group-hover:scale-120 md:group-hover:translate-y-10
              "
            />
          </div>
        </div>
